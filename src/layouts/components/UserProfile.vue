<script setup lang="ts">
  ...
  const userProfileList = [
    { type: 'divider' },
    /* { type: 'navItem', icon: 'tabler-user', title: 'Profile', to: { path: '/user-view', query: { userId: userData.value.id } } }, */
    /* { type: 'navItem', icon: 'tabler-user', title: 'Profile', to: { name: 'user-view', params: { id: 21 } } }, */
     { type: 'navItem', icon: 'tabler-settings', title: 'Settings', to: { name: 'pages-account-settings-tab', params: { tab: 'account' } } },
    // { type: 'navItem', icon: 'tabler-file-dollar', title: 'Billing Plan', to: { name: 'pages-account-settings-tab', params: { tab: 'billing-plans' } }, badgeProps: { color: 'error', content: '5' } },
    { type: 'divider' },
