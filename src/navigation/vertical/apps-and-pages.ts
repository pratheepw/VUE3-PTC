export default [
  ...
  },
  {
    ...
    children: [
      { title: 'View', to: { name: 'user-view', params: { userId: 21 } } },
    ],
  },
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Register Multi-Steps', to: 'register-multi-steps', target: '_blank' },
        ],
      },
      {
        title: 'Verify Email',
        children: [
          ...
          { title: 'Verify Email v2', to: 'verify-email', target: '_blank' },
        ],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Reset Password v2', to: 'reset-password', target: '_blank' },
        ],
      },
      {
        title: 'Two Steps',
