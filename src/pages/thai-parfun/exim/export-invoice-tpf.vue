<script setup lang="ts">
    ...
    myStore.currentPageTitle='Thai Parfun / Exim / Export Invoice'
        ...
        const dataSource:IDatasource={
            ...
            getRows:async(params:IGetRowsParams)=>{
                try {
                    ...
                    const {data,footer} = await $api<any>(`${import.meta.env.BASE_URL}api/thaiparfun/GetExportInvoiceTPFPartial?searchBy=${searchBy.value}&txtSearch=${textSearch.value}&request=${JSON.stringify(request)}&exportExcel=false`)
                    if(footer){
                        rowFooter.value=[{
    ...
    const exportExcel=async()=>{
        try {
            ...
            const res = await $api<any>(`${import.meta.env.BASE_URL}api/thaiparfun/GetExportInvoiceTPFPartial?searchBy=${searchBy.value}&txtSearch=${textSearch.value}&request=${JSON.stringify(request)}&exportExcel=true`)
